...
def parse_args():
    ...
    parser.add_argument('--data_dir', type=str, default='/media/anarchicorganizer/Qiqi/',
    ...
    parser.add_argument('--model', type=str, default='MLP', choices=['MLP', 'ResNet', 'DenseNet', 'NIN'],
